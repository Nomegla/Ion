...
import net.horizonsend.ion.server.features.machine.BoilerFuel
...
object BoilerMultiblockItemFuel : BoilerMultiblock<ItemBoilerEntity>() {
	...
	class ItemBoilerEntity(
		...
		override fun IOData.Builder.registerAdditionalIO(): IOData.Builder = addPort(IOType.FLUID, 0, 1, 6) {
			IOPort.RegisteredMetaDataInput(this@ItemBoilerEntity, FluidPortMetadata(
		...
		override fun preTick(): Boolean {
			...
			for (itemStack: ItemStack? in fuelInput.contents) {
				...
				val fuelProperties = BoilerFuel[itemStack] ?: continue
